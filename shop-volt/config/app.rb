...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'webshop.com'
  config.app_name = 'webshop'
  config.mailer.from = 'webshop <no-reply@webshop.com>'
  ...
  #
  config.app_secret = 'iwgPZoAVhrB8y5n6dHVkINKDRT-Tq5gEsTX1OcCoTD2JSYnGHqjNKIsBlybKjUnp_18'
